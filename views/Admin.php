...
<div class="max-w-md mx-auto p-6 bg-gray-800 bg-opacity-70 rounded-lg shadow-lg mt-16 text-gray-200">
    <h1 class="text-3xl font-semibold text-indigo-300 mb-6">Group Management</h1>
                ...
                <form method="get" action="/tasks">
                    <li class="flex items-center justify-between bg-gray-700 p-4 rounded">
                        <div class="flex items-center space-x-2">
                            <span class="text-gray-300"></span><?= $group->id." : ".$group->name ?>
                            <span class="text-gray-300"></span>
                        </div>
                        <div class="flex space-x-2">
                            <a href="?delete=<?= $group->id ?>" class="text-red-300 hover:text-red-400 focus:outline-none">
...
<div class="max-w-md mx-auto p-6 bg-gray-800 bg-opacity-70 rounded-lg shadow-lg mt-16 text-gray-200">
    ...
    <div>
        ...
        <form method="post" class="space-y-4" action="/admin">
            <div>
                <label for="itemName" class="block text-sm font-medium text-gray-400 mb-1">Group Name:</label>
                <input type="text" id="itemName" name="groupName" class="mt-1 px-4 py-2 w-full border rounded-md bg-gray-700 text-gray-200">
            </div>
